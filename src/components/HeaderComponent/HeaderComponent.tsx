        ...
        <>
            <div className="fixed z-50 flex items-center w-full h-16 justify-between mont-montserrat bg-[#003550]">
                <div onClick={() => router.push("/home")} className="w-[80%] px-4 cursor-pointer">
                    <Image src={"/catolica_png.png"} width={40} height={40} alt="a"></Image>
                </div>
                <div className="flex items-center justify-end w-[20%] px-4 h-8 gap-4 cursor-pointer text-white">
                    <div className="flex ">
                        <div onClick={() => router.push("/register")} className="flex items-center justify-center h-full">
                            <span>Registrar-se</span>
                        </div>
                        <div onClick={() => router.push("/login")} className="flex items-center justify-center rounded-md text-branco  w-[5rem] h-full cursor-pointer ">
                            <span>Entrar</span>
                        </div>
                    </div>
                    <div className="flex items-center justify-center text-center w-fit pt-1">
