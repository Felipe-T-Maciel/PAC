                            ...
                            {[{
                                ...
                                >
                                    ...
                                    <motion.div variants={containerVariants} initial="hidden" animate="show" className="flex flex-col items-center gap-2">
                                        ...
                                        <motion.span variants={itemVariants}>{item.desc}</motion.span>
                                    </motion.div>
                                </motion.div>
                            ))}
                        </div>
            ...
            <section ref={section2Ref} className="h-screen snap-start flex items-center justify-center">
                ...
                <div className="flex flex-col items-center justify-center gap-20">
                    <div className="flex items-center gap-4 z-10">
                        <motion.div variants={itemVariants} className="flex flex-col justify-around w-96 h-52 gap-4">
              ...
              "
                        ...
                        <div className="bg-gray-300 w-1 h-56" />
